...
<#
.SYNOPSIS
    Post-install script for Windows 11 Home PC
.DESCRIPTION
...
.LINK
    https://github.com/MarcoJanse/ProfilesAndSettings/WindowsDeployment/Win11Postinstall_homePC.ps1
.EXAMPLE
    .\Win11PostInstall_homePC.ps1
